                ...
                () => isLoading.value ? const SizedBox(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10),
                      Text("Mendapatkan Akun...", style: TextStyle(color: Colors.black45, fontSize: 13))
                    ],
                  ),
                ) : listAccountReal.length < 1 ? const SizedBox(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Icon(Iconsax.empty_wallet_add_outline, color: Colors.black45, size: 35),
                      SizedBox(height: 10),
                      Text("Akun real anda kurang dari 2", style: TextStyle(color: Colors.black45, fontSize: 13))
                    ],
                  ),
                ) : Column(
                  children: [
                    Container(
                      ...
                      child: const Icon(MingCute.transfer_vertical_line, color: Colors.black45, size: 50),
                    ),
                    SizedBox(
                      width: size.width,
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => isLoading.value ? const SizedBox() : Form(
                          key: formKey,
                          child: AnyTextField(
                            prefix: const Text("\$ ", style: TextStyle(color: Colors.black45, fontSize: 13),),
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(accountTypeName ?? "Lite", style: const TextStyle(color: Colors.black38, fontWeight: FontWeight.bold, fontSize: 15)),
                  const SizedBox(width: 10),
                  Text(accountNumber ?? "0", style: const TextStyle(color: Colors.black38, fontWeight: FontWeight.bold, fontSize: 15)),
                ],
              ),
              Text("\$${balance ?? "0"}", style: const TextStyle(color: Colors.black45, fontWeight: FontWeight.bold, fontSize: 35)),
              Text(currency ?? 'N/A', style: const TextStyle(color: Colors.black45, fontWeight: FontWeight.bold, fontSize: 20)),
            ],
          ),
        ),
      ],
